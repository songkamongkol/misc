...
# example: sudo ./deploy_ls_stc_to_test.sh 5.18.0296
...
docker tag $ls_image_id 127.0.0.1:5000/labserver:${mj_version}
docker push 127.0.0.1:5000/labserver:${mj_version}
...
docker tag ${stc_image_id} 127.0.0.1:5000/stc:${release_version}
docker push 127.0.0.1:5000/stc:${release_version}
